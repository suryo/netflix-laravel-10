    ...
    <div class="flex">
        ...
        <aside class="w-64 min-h-screen bg-admin-card border-r border-admin-border fixed left-0 top-0 z-40 hidden lg:block">
            ...
            <nav class="py-4">
                ...
                <a href="{{ route('admin.tv-channels.index') }}" class="sidebar-link flex items-center gap-3 px-6 py-3 text-sm font-medium {{ request()->routeIs('admin.tv-channels.*') ? 'active' : '' }}">
